...
The **NmeaProcessor** library is included in the **Meadow.Foundation.Sensors.Location.Gnss.NmeaProcessor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
