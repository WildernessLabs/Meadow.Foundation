...
The **MicroAudio** library is included in the **Meadow.Foundation.Audio.MicroAudio** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Audio.MicroAudio`
## How to Contribute
