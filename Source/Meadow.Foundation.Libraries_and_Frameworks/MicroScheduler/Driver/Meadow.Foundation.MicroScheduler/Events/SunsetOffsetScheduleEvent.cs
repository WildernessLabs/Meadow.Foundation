...
/// </summary>
public class SunsetOffsetScheduleEvent : ScheduleEventBase
{
    /// <summary>
    /// Gets the type of this schedule event.
    /// </summary>
    public override ScheduleEventType EventType => ScheduleEventType.SunsetOffset;
    ...
    public SunsetOffsetScheduleEvent(TimeSpan offset, string? data = null, DayOfWeek[]? daysOfWeek = null)
    {
        Offset = offset;
        Data = data;
