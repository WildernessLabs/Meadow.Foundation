...
The **SixteenSegment** library is included in the **Meadow.Foundation.Displays.Led.SixteenSegment** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
