...
The **Lis3mdl** library is included in the **Meadow.Foundation.Sensors.Motion.Lis3mdl** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Motion.Lis3mdl`
## Usage
