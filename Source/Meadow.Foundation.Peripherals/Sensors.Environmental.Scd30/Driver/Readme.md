...
The **Scd30** library is included in the **Meadow.Foundation.Sensors.Environmental.Scd30** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
