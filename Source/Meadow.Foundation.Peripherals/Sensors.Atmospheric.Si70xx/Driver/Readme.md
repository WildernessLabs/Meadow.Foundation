...
The **Si70xx** library is included in the **Meadow.Foundation.Sensors.Atmospheric.Si70xx** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Atmospheric.Si70xx`
## Usage
