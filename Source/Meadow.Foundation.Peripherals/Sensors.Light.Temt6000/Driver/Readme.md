...
The **Temt6000** library is included in the **Meadow.Foundation.Sensors.Light.Temt6000** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
