...
The **Thermistor** library is included in the **Meadow.Foundation.Sensors.Temperature.Thermistor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
