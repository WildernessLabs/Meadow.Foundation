...
The **Tca95x5** library is included in the **Meadow.Foundation.ICs.IOExpanders.Tca95x5** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
