...
The **Mt3339** library is included in the **Meadow.Foundation.Sensors.Gnss.Mt3339** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
