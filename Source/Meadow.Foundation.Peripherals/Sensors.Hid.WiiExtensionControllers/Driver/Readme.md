...
The **WiiExtensionControllers** library is included in the **Meadow.Foundation.Sensors.Hid.WiiExtensionControllers** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
