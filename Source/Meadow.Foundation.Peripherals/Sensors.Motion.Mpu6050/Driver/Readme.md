...
The **Mpu6050** library is included in the **Meadow.Foundation.Sensors.Motion.Mpu6050** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
