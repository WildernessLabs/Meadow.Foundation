...
The **Lis3mdl** library is included in the **Meadow.Foundation.Sensors.Motion.Lis3mdl** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
