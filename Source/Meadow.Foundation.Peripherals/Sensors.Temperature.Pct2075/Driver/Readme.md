...
The **Pct2075** library is included in the **Meadow.Foundation.Sensors.Temperature.Pct2075** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
