...
The **Bh1900Nux** library is included in the **Meadow.Foundation.Sensors.Atmospheric.Bh1900Nux** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Atmospheric.Bh1900Nux`
## Usage
