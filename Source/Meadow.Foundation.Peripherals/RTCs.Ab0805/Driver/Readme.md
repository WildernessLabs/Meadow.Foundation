...
The **Ab0805** library is included in the **Meadow.Foundation.RTCs.Ab0805** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
