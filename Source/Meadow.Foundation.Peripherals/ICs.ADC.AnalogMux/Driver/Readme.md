...
The **AnalogMux** library is included in the **Meadow.Foundation.ICs.ADC.AnalogMux** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
