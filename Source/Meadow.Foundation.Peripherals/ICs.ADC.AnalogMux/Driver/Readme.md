# Meadow.Foundation.ICs.ADC.AnalogMux

**Library for various analog multiplexers**

The **AnalogMux** library is included in the **Meadow.Foundation.ICs.ADC.AnalogMux** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.ICs.ADC.AnalogMux`
## Usage
