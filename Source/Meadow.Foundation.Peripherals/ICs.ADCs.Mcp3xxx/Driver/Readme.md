...
The **Mcp3xxx** library is included in the **Meadow.Foundation.ICs.ADCs.Mcp3xxx** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.ICs.ADCs.Mcp3xxx`
## Usage
