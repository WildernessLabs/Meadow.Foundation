...
The **Ht16k33** library is included in the **Meadow.Foundation.ICs.IOExpanders.Ht16k33** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.ICs.IOExpanders.Ht16k33`
## Usage
