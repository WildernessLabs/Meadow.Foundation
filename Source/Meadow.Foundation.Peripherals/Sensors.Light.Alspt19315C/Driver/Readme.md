...
The **Alspt19315C** library is included in the **Meadow.Foundation.Sensors.Light.Alspt19315C** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
