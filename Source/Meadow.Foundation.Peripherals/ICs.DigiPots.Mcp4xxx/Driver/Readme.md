...
The **Mcp4xxx** library is included in the **Meadow.Foundation.ICs.DigiPots.Mcp4xxx** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
