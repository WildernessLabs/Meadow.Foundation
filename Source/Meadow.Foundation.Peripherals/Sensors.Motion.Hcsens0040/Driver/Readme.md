...
The **Hcsens0040** library is included in the **Meadow.Foundation.Sensors.Motion.Hcsens0040** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
