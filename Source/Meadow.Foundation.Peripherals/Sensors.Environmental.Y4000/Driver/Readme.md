...
The **Y4000** library is included in the **Meadow.Foundation.Sensors.Environmental.Y4000** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
