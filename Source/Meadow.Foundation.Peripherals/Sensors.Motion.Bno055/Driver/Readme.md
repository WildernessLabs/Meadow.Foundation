...
The **Bno055** library is included in the **Meadow.Foundation.Sensors.Motion.Bno055** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
