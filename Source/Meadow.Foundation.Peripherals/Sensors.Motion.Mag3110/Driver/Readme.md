...
The **MAG3110** library is included in the **Meadow.Foundation.Sensors.Motion.Mag3110** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Motion.Mag3110`
## Usage
