...
The **MAG3110** library is included in the **Meadow.Foundation.Sensors.Motion.Mag3110** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
