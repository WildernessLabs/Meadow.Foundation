...
The **Ky038** library is included in the **Meadow.Foundation.Sensors.Sound.Ky038** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Sound.Ky038`
## Usage
