...
The **Vl53l0x** library is included in the **Meadow.Foundation.Sensors.Distance.Vl53l0x** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
