...
The **V10x** library is included in the **Meadow.Foundation.Batteries.Voltaic.V10x** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
