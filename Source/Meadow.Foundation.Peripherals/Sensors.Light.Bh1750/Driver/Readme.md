...
The **Bh1750** library is included in the **Meadow.Foundation.Sensors.Light.Bh1750** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
