...
The **WindVane** library is included in the **Meadow.Foundation.Sensors.Weather.WindVane** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
