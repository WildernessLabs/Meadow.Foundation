...
/// </summary>
/// <remarks>
/// The MAX17043 is a fuel gauge that implements the ModelGauge algorithm to track battery state of charge (SOC)
/// with an accuracy of 1% without requiring battery characterization or current sensing
/// </remarks>
public class Max17043 : Max1704x
{
    /// <summary>
    /// Initializes a new instance of the MAX17043 fuel gauge
    /// </summary>
    /// <param name="i2cBus">The I2C bus connected to the fuel gauge</param>
    /// <remarks>
    /// This constructor initializes the fuel gauge with the fixed voltage scaling factor of 1.25
    /// for the MAX17043 model
    /// </remarks>
    public Max17043(
        II2cBus i2cBus
        )
    ...
    /// <summary>
    /// Initializes a new instance of the MAX17043 fuel gauge with alert functionality
    /// </summary>
    /// <param name="i2cBus">The I2C bus connected to the fuel gauge</param>
    ...
    public Max17043(
        ...
        : base(i2cBus, 1.25, alertInterruptPin, alertThresholdPercent)
    {
    }
}