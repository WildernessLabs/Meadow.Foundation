...
The **At24Cxx** library is included in the **Meadow.Foundation.ICs.EEPROM.At24Cxx** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
