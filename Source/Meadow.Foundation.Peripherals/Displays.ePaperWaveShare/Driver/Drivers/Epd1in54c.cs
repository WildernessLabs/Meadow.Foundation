...
namespace Meadow.Foundation.Displays
{
    ...
    public class Epd1in54c : Il0376F
    {
        ...
        public Epd1in54c(IMeadowDevice device, ISpiBus spiBus, IPin chipSelectPin, IPin dcPin, IPin resetPin, IPin busyPin) :
            base(device, spiBus, chipSelectPin, dcPin, resetPin, busyPin, 152, 152)
        { }
