...
The **ePaperWaveShare** library is included in the **Meadow.Foundation.Displays.ePaperWaveShare** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
