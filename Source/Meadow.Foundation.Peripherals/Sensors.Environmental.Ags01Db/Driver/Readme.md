...
The **Ags01Db** library is included in the **Meadow.Foundation.Sensors.Environmental.Ags01Db** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
