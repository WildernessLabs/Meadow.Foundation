...
The **Ags01Db** library is included in the **Meadow.Foundation.Sensors.Environmental.Ags01Db** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Environmental.Ags01Db`
## Usage
