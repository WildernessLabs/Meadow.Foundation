...
The **Bmp085** library is included in the **Meadow.Foundation.Sensors.Atmospheric.Bmp085** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Atmospheric.Bmp085`
## Usage
