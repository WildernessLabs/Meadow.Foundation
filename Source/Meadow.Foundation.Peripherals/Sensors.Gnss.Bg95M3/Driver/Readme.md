...
The **Bg95M3** library is included in the **Meadow.Foundation.Sensors.Gnss** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
