...
The **ParallaxPir** library is included in the **Meadow.Foundation.Sensors.Motion.ParallaxPir** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
