...
The **AtlasScientificGravityDOMeter** library is included in the **Meadow.Foundation.Sensors.Environmental.AtlasScientificGravityDOMeter** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
