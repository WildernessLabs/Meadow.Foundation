...
The **Sht31d** library is included in the **Meadow.Foundation.Sensors.Atmospheric.Sht31d** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
