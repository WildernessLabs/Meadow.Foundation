...
The **As5013** library is included in the **Meadow.Foundation.Sensors.Hid.As5013** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
