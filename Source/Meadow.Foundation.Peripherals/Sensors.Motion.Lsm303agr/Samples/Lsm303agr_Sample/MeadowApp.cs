...
namespace Lsm303agr_Sample
{
    ...
    public class MeadowApp : App<F7FeatherV1>
    {
            ...
            MagneticField3D? MagneticField3D)> result)
        {
            ...
            Console.WriteLine($"AccelX={accel.X.Gravity:0.##}g, AccelY={accel.Y.Gravity:0.##}g, AccelZ={accel.Z.Gravity:0.##}g, MagX={mag.X.Gauss:0.##}gauss, MagY={mag.Y.Gauss:0.##}gauss, GyroZ={mag.Z.Gauss:0.##}gauss");
        }
