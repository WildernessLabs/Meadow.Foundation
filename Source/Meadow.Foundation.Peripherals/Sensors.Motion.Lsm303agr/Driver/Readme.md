...
The **Lsm303agr** library is included in the **Meadow.Foundation.Sensors.Motion.Lsm303agr** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
