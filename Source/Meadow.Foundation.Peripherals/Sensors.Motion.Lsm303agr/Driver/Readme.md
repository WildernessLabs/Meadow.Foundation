...
The **Lsm303agr** library is included in the **Meadow.Foundation.Sensors.Motion.Lsm303agr** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Motion.Lsm303agr`
## Usage
