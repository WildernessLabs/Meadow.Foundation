...
The **Me007ys** library is included in the **Meadow.Foundation.Sensors.Distance.Me007ys** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Distance.Me007ys`
## Usage
