# Meadow.Foundation.Sensors.Volume.ResistiveTankLevelSender

**A generic resistive tank level sending unit**

The **ResistiveTankLevelSender** library is included in the **Meadow.Foundation.Sensors.Volume.ResistiveTankLevelSender** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Volume.ResistiveTankLevelSender`
## Usage
