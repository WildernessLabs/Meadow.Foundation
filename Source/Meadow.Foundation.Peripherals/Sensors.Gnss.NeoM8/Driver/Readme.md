...
The **NeoM8** library is included in the **Meadow.Foundation.Sensors.Gnss.NeoM8** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Gnss.NeoM8`
## Usage
