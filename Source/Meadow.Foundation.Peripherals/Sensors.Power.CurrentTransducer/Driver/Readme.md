...
The **CurrentTransducer** library is included in the **Meadow.Foundation.Sensors.Power.CurrentTransducer** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
