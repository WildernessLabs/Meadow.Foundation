...
The **Ds3502** library is included in the **Meadow.Foundation.ICs.DigiPots.Ds3502** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.ICs.DigiPots.Ds3502`
## Usage
