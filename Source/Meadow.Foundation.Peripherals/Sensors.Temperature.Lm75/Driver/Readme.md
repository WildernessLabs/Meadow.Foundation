...
The **Lm75** library is included in the **Meadow.Foundation.Sensors.Temperature.Lm75** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
