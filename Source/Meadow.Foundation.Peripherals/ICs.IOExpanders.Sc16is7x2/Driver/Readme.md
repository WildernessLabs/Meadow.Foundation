...
The **Sc16is7x2** library is included in the **Meadow.Foundation.ICs.IOExpanders.Sc16is7x2** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
