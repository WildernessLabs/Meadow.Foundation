...
The **Arducam** library is included in the **Meadow.Foundation.Sensors.Camera.Arducam** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
