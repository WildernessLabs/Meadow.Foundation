...
The **Lis2Mdl** library is included in the **Meadow.Foundation.Sensors.Motion.Lis2Mdl** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
