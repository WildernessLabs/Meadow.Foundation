...
The **CMBusMaster** library is included in the **Meadow.Foundation.mikroBUS.Sensors.MBus.CMBusMaster** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
