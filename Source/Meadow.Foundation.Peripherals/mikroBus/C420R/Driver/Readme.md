...
The **C420R** library is included in the **Meadow.Foundation.mikroBUS.Sensors.C420R** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
