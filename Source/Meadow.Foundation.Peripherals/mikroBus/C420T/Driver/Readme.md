...
The **C420T** library is included in the **Meadow.Foundation.mikroBUS.Sensors.C420T** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
