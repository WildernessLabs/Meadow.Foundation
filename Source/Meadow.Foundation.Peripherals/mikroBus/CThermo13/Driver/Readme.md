...
The **CThermo13** library is included in the **Meadow.Foundation.mikroBUS.Sensors.Atmospheric.CThermo13** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
