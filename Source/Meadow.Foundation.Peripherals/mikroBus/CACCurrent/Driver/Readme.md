...
The **CACCurrent** library is included in the **Meadow.Foundation.mikroBUS.Sensors.CACCurrent** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
