...
The **Ft2xxx** library is included in the **Meadow.Foundation.ICs.IOExpanders.Ftxxxx** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
