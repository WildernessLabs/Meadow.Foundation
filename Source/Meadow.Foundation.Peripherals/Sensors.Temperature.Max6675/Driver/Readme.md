...
**Max6675 SPI thermocouple temperature sensor**

The **Max6675** library is included in the **Meadow.Foundation.Sensors.Temperature.Max6675** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Temperature.Max6675`
## Usage
