...
The **Amg8833** library is included in the **Meadow.Foundation.Sensors.Camera.Amg8833** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
