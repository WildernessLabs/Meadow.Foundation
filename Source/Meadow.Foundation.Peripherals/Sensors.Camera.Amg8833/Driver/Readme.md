...
The **Amg8833** library is included in the **Meadow.Foundation.Sensors.Camera.Amg8833** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Camera.Amg8833`
## Usage
