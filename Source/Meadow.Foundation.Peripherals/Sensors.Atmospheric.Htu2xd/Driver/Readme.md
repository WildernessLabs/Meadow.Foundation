...
The **Htux1d** library is included in the **Meadow.Foundation.Sensors.Atmospheric.Htux1d** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
