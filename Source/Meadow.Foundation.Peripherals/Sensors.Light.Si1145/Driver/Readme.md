...
The **Si1145** library is included in the **Meadow.Foundation.Sensors.Light.Si1145** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Light.Si1145`
## Usage
