...
The **Si1145** library is included in the **Meadow.Foundation.Sensors.Light.Si1145** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
