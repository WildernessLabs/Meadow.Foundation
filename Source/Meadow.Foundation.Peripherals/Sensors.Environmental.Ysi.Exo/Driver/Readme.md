# Meadow.Foundation.Sensors.Environmental.Ysi.Exo

**Driver for the EXO line of YSI Modbus Water Quality Sensors**

The **Ysi.Exo** library is included in the **Meadow.Foundation.Sensors.Environmental.Ysi.Exo** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
