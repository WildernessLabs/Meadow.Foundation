...
The **Veml7700** library is included in the **Meadow.Foundation.Sensors.Light.Veml7700** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
