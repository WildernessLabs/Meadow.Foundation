...
The **SevenSegment** library is included in the **Meadow.Foundation.Displays.Led.SevenSegment** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Displays.Led.SevenSegment`
## Usage
