...
The **SevenSegment** library is included in the **Meadow.Foundation.Displays.Led.SevenSegment** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
