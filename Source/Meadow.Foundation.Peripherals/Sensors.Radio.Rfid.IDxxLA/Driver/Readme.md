...
The **IDxxLA** library is included in the **Meadow.Foundation.Sensors.Radio.Rfid.IDxxLA** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
