...
The **IDxxLA** library is included in the **Meadow.Foundation.Sensors.Radio.Rfid.IDxxLA** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Radio.Rfid.IDxxLA`
## Usage
