...
The **AnalogSolarIntensityGauge** library is included in the **Meadow.Foundation.Sensors.Light.AnalogSolarIntensityGauge** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
