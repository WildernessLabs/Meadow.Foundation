...
The **Tsc2004** library is included in the **Meadow.Foundation.Sensors.Hid.Tsc2004** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
