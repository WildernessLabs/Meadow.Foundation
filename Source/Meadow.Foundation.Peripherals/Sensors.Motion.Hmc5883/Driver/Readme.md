...
The **Hmc5883** library is included in the **Meadow.Foundation.Sensors.Motion.Hmc5883** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
