...
The **Hmc5883** library is included in the **Meadow.Foundation.Sensors.Motion.Hmc5883** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
...
`dotnet add package Meadow.Foundation.Sensors.Motion.Hmc5883`
## Usage
