...
namespace Meadow.Foundation.LEDs
{
    ...
    public class RgbPwmLed
    {
        ...
        public PWM RedPwm { get; protected set; }
        public Cpu.PWMChannel GreenPin { get; protected set; }
        public PWM BluePwm { get; protected set; }
        public Cpu.PWMChannel BluePin { get; protected set; }
        public PWM GreenPwm { get; protected set; }
        ...
        public RgbPwmLed(
            Cpu.PWMChannel redPin, Cpu.PWMChannel greenPin, Cpu.PWMChannel bluePin,
